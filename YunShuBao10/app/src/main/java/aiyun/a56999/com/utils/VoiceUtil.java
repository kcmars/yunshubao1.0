 ...
 * @Date 2018/4/17
 */
public class VoiceUtil implements InitListener {
...
//        mTts.startSpeaking("科大讯飞，让世界聆听我们的声音", mSynListener);
     ...
     * 开始合成
     */
    public void startSpeakingNow(){
        if (mTts != null) {
            mTts.startSpeaking("welcome", mSynListener);
        } else {
            Log.e(TAG, "speakingNow: " + mTts );
        }
    }
     ...
     * 终止合成
     */
    public void stopSpeakingNow(){
        if (mTts != null) {
            mTts.stopSpeaking();
        } else {
            Log.e(TAG, "stopSpeakingNow: " + mTts );
        }
    }
